                            ...
                            <form className="space-y-4" action="#">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="password"
                                        placeholder="••••••••"
                                        className="bg-gray-50 mb-2 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-800 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                        value={password}
                                ...
                                <GradientButton onClick={handleSignIn} isLoading={loading} text={'Login to your account'} className='w-full' />
                                <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                                    Not registered? <span className="hover:underline text-blue-500" onClick={openSignUpModal}>Create account</span>
                                </div>
                            </form>
                        </div>
                    </div>
