                    ...
                    <div className="relative rounded-lg shadow bg-cosmic-dark border border-white/10">
                        ...
                        <div className="p-4 md:p-5">
                            <form className="space-y-4" action="#">
                                ...
                                <GradientButton onClick={handleSignUp} isLoading={loading} text={'Create account with Email'} className='w-full' />
                                ...
                                <div className="text-sm font-medium text-gray-300 text-center">
                                    Already registered? <span className="hover:underline text-cosmic-purple cursor-pointer" onClick={openSignInModal}>Sign in</span>
                                </div>
                            </form>
                        </div>
                    </div>
